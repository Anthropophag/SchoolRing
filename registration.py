...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.On)
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap("ui\\../icons/registration/ring.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.On)
